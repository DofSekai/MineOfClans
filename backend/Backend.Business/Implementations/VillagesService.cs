...
namespace Backend.Business.Implementations
{
    public class VillagesService : IVillagesService
    {
        ...
        public VillagesService(IVillagesDataAccess villagesDataAccess, IRankupMinesDataAccess rankupMinesDataAccess,
            IRankupHdvsDataAccess rankupHdvsDataAccess, ILevelMinesDataAccess levelMinesDataAccess,
            ILevelHdvsDataAccess levelHdvsDataAccess, ILogger<VillagesService> logger)
        {
